...
<div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 2px solid #f1f1f1; padding-bottom: 15px; margin-bottom: 20px; padding-right: 40px">
    ...
    <div style="display: flex; gap: 10px;">
        <a href="../api/export_report.php?program_name=<?php echo urlencode($program_name); ?>" style="background: #FFCC00; padding: 8px 15px; border-radius: 8px; text-decoration: none; color: #000; font-weight: bold;">
